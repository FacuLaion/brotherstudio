...
const es: Dictionary = {
  ...
  gesture: {
    ...
    hint: "✊ Pellizcá (pulgar + índice) y arrastrá ↑/↓ para desplazar · sobre una imagen, pellizcá y movés ← → para cambiarla · mové la cabeza para mirar",
...
const en: Dictionary = {
  ...
  gesture: {
    ...
    hint: "✊ Pinch (thumb + index) and drag ↑/↓ to scroll · over an image, pinch and move ← → to change it · move your head to look",
